...
<a class="w3-left w3-btn" href="python_ml_knn.asp">&#10094; Previous</a>
...
<p>To be able to experiment with the code examples in this tutorial, you should 
have MySQL installed on your computer.</p>
<p>You can download a MySQL database at
...
<div class="w3-code notranslate jsHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp; user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; password=&quot;<em>yourpassword</em>&quot;<br>)<br>
  <br>print(mydb)</div>
